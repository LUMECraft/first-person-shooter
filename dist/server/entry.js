...
const playerConnectionResetTimeouts = new Map(); // Map works.
Meteor.methods({
    async addPlayer() {
        playerId++;
        ...
        playerConnectionResetTimeouts.set(id, createDebounce(
    ...
    async updatePlayer({ id, x, y, z, rx, ry, crouch }) {
...
const mapItemTypes = ['tree', 'stone', 'shrub', 'shrub2', 'big_tree'];
const promises = [];
for (let i = 0; i < 30; i += 1) {
    promises.push(mapItems.insertAsync({
